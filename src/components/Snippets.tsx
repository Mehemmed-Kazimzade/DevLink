            ...
            <Card sx={{ height: "100%", bgcolor: "transparent" }}>
              <CardContent>
                <Box display="flex" alignItems="center" justifyContent={"space-between"} mb={2}>
                  ...
                  <EditAction title={"Editing snipper" + snippet.title } fields={[
                    { type: "text", currValue: snippet.title, ref: useRef<HTMLInputElement>(null) },
                    { type: "bigText", currValue: snippet.preview, ref: useRef<HTMLTextAreaElement>(null) },
                  ]} />
                </Box>
                <Chip
